...
*¡Te deseamos el mejor de los éxitos en tu partido!* 🏆🔥`;
  ...
  if (!accountSid || !authToken) {
    const errorMsg = 'NOTIFICACIÓN SIMULADA: Faltan credenciales de Twilio en .env.example (TWILIO_ACCOUNT_SID y TWILIO_AUTH_TOKEN)';
    ...
    return {
      ...
      body: messageBody,
      error: 'Twilio no configurado. El mensaje fue simulado en consola.'
    };
  }
