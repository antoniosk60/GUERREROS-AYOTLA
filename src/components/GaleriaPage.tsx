...
const SIMULATED_CHAT_POOL = [
  { sender: 'Luis_Ayotla', text: '¡Venga Guerreros! Se ve increíble hoy.' },
  ...
  { sender: 'Yael_Ayotla', text: 'La cancha techada se ve nítida de noche.' },
  { sender: 'Ixtapaluca_Pro', text: 'Se viene penal... ¡atoya!' },
...
export default function GaleriaPage() {
  ...
  const [chatMessages, setChatMessages] = useState<{ sender: string; text: string; time: string; isUser?: boolean }[]>([
    ...
    { sender: 'Moderador', text: 'Bienvenidos a la transmisión oficial de Guerreros Ayotla.', time: '12:01' },
    { sender: 'Carlos_M', text: '¡Saludos desde Ixtapaluca! Con todo Guerreros.', time: '12:02' }
  ]);
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="space-y-4 text-center lg:text-left">
        <div className="inline-flex items-center space-x-2 bg-emerald-500/10 border border-emerald-500/20 px-3.5 py-1.5 rounded-full select-none">
          ...
          <span className="text-xs font-mono font-bold text-emerald-400 uppercase tracking-widest">Multimedia Oficial Guerreros Ayotla</span>
        </div>
